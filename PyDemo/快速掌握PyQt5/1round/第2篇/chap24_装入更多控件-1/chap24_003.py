...
from PyQt5.QtWidgets import (
    QApplication, QWidget, QStackedWidget, QTextEdit, QHBoxLayout,
    QLabel, QGridLayout, QListWidget, QLineEdit, QComboBox, QDateEdit
)
...
class Demo(QWidget):
    ...
    def stack1_init(self):
        ...
        g_layout.addWidget(bd_label, 4, 0, 1, 1)
        g_layout.addWidget(bd_dateedit, 4, 1, 1, 1)
    ...
    def stack2_init(self):
        ...
        g_layout.addWidget(mobile_label, 2, 0, 1, 1)
        g_layout.addWidget(mobile_line, 2, 1, 1, 1)

        g_layout.addWidget(add_label, 4, 0, 1, 1)
        g_layout.addWidget(add_line, 4, 1, 1, 1)
